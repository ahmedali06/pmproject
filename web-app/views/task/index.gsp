		...
		<div id="list-task" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="reportedBy" title="${message(code: 'task.reportedBy.label', default: 'Reported By')}" />
					
						<g:sortableColumn property="assignTo" title="${message(code: 'task.assignTo.label', default: 'Assign To')}" />
				...
				<g:each in="${taskInstanceList}" status="i" var="taskInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: taskInstance, field: "reportedBy")}</td>
