		...
		<div id="list-comment" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="commentsBy" title="${message(code: 'comment.commentsBy.label', default: 'Comments By')}" />
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: commentInstance, field: "commentsBy")}</td>
